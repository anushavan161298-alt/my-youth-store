...
export default function UserOrdersPage() {
  ...
  if (!isHydrated || loading) return <div className="p-20 text-center">Загрузка заказов...</div>;

  if (!user) {
    return (
      <div className="p-20 text-center">
        <h2 className="text-2xl font-bold mb-4">Пожалуйста, войдите в систему</h2>
        <Link href="/admin" className="text-indigo-600 hover:underline">Перейти ко входу</Link>
      </div>
    );
  }
                ...
                <div className="p-6">
                  ...
                  <div className="pt-6 border-t border-gray-50 flex justify-between items-center">
                    <div className="flex items-center gap-2 text-gray-500 text-sm">
                      ...
                      {order.paymentMethod === 'sbp' ? 'СБП' : 'Карта'}
                    </div>
